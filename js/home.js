document.addEventListener('DOMContentLoaded', function () {
  var heroSlides = [
    ...
    { img: 'assets/earthkeepers.jpg', l1: 'Animated', l2: 'Edutainment Series', title: 'Coming 2028' },
    { img: 'assets/beasties-anim.jpg', l1: 'Animated', l2: 'Edutainment Series', title: 'Coming 2028' }
  ];
